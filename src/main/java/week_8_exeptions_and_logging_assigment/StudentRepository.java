...
public class StudentRepository {
    ...
    public void addStudentToDataBase(Student student){
        ...
        if(dataBaseSizeBeforeAddingThisStudent==dataBaseSizeAfterAddingThisStudent){
            System.out.println("You already have this "+ student+" in the data base.");
        }else{
            System.out.println(student+ " has been successfully added to the data base.");
        }
    ...
    public void deleteStudentFromDataBase(String id){
        ...
        if(student==null){
            System.out.println("No such student found in the data base");
            return;
        }
        studentsDataBase.remove(student);
        System.out.println("Successfully deleted "+student+" from the data base.");
    }
    ...
    for(Student student:studentsDataBase){
        ...
        if(listOfStudents.isEmpty()){
            System.out.println("There is no student with this age: "+age);
        }
        else{
    ...
    public void listStudentsOrderedByBirthDay(){
        ...
        System.out.println("Printing students sorted by they're birthday from the oldest to the youngest. ");
        System.out.println(listOfStudents);
    }
